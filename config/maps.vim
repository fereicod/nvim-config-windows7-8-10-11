...
" ejecutar archivos JavaScript con Nodejs
nnoremap <Leader>d :!node %<CR>

" abrir terminal cmd con [ctrl+t] así podrás ejecutar otro tipo de archivos (java, python, etc...)
vnoremap <c-t> :split<CR> :terminal<CR>:resize 12<CR>
nnoremap <c-t> :split<CR> :terminal<CR>:resize 12<CR>
...
" comentar líneas en modo NORMAL
...
" ¡investiga lo que realiza este comando!
nmap <Leader>r :CocCommand explorer<CR>
nmap <Leader>rr :CocCommand explorer --preset floating<CR>
